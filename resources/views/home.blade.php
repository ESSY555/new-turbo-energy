...
<body class="sidebar-mini fixed">
   ...
   <div class="wrapper">
      ...
      <header class="main-header-top hidden-print">
         <a href="index.html" class="logo"><img class="img-fluid able-logo" src="{{asset('assets/auth/images/logo.png" alt="Theme-logo')}}"></a>
               ...
               <ul class="top-nav">
                  ...
                  <li class="dropdown">
                     <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image">
                        ...
                        <span>Adewumi <b>Essy</b> <i class=" icofont icofont-simple-down"></i></span>
         ...
         <section class="sidebar" id="sidebar-scroll">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    <a class="waves-effect waves-dark" href="{{ url('new-accordion') }}">
...
{{-- 
                ...
                <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-book-open"></i><span> finance</span><i class="icon-arrow-down"></i></a>
                    <ul class="treeview-menu">
                        <li><a class="waves-effect waves-dark" href="form-elements-bootstrap.html"><i class="icon-arrow-right"></i>Fill Voucher</a></li>
                        
                        <li><a class="waves-effect waves-dark" href="form-elements-advance.html"><i class="icon-arrow-right"></i> Salary Display</a></li>
                        <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-book-open"></i><span>Payment Confirmation</span><i class="icon-arrow-down"></i></a>
                           <ul class="treeview-menu">
                               <li><a class="waves-effect waves-dark" href="form-elements-bootstrap.html"><i class="icon-arrow-right"></i>P4P</a></li>
                               
                               <li><a class="waves-effect waves-dark" href="form-elements-advance.html"><i class="icon-arrow-right"></i>Turbo</a></li>
                           </ul>
                       </li>
                    </ul>
                </li>

                <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-book-open"></i><span>Facility</span><i class="icon-arrow-down"></i></a>
                    <ul class="treeview-menu">
                        <li><a class="waves-effect waves-dark" href="form-elements-bootstrap.html"><i class="icon-arrow-right"></i>Complaint</a></li>
                        
                        <li><a class="waves-effect waves-dark" href="form-elements-advance.html"><i class="icon-arrow-right"></i>Requirement</a></li>
                    </ul>
                </li>
         ...
         <div class="container-fluid">
          ...
          <div class="row">
             <div class="col-lg-4">
                <div class="card">
                   <div class="user-block-2">
                      <img class="img-fluid" src="{{asset('assets/auth/images/widget/user-1.png')}}" alt="user-header">
                      <h5>Ade Villa</h5>
             ...
             <div class="col-xl-4 col-lg-12 grid-item">
                <div class="card">
                   <div class="card-block horizontal-card-img d-flex">
                      <img class="media-object img-circle" src="{{asset('assets/auth/images/avatar-3.png')}}" alt="Generic placeholder image">
                      <div class="d-inlineblock  p-l-20">
                        <h6>adewumi israel</h6>
                        <a href="#">adewumiisrael66@gmail.com</a>
                     </div>
             ...
             <div class="col-xl-4 col-lg-12 grid-item">
                <div class="card">
                   <div class="card-block horizontal-card-img d-flex">
                      <img class="media-object img-circle" src="{{asset('assets/auth/images/lockscreen.png')}}" alt="Generic placeholder image">
                      <div class="d-inlineblock  p-l-20">
                        <h6>adewumi israel</h6>
                        <a href="#">adewumiisrael66@gmail.com</a>
                     </div>
                      ...
                      <div class="table-responsive">
                         <table class="table m-b-0 photo-table">
                            ...
                            <tbody>
                               <tr>
                                  <th>
                                     <img class="img-fluid img-circle" src="{{asset('assets/auth/images/avatar-2.png')}}" alt="User">
                                  </th>
                                  <td>Appestia Project
                               ...
                               <tr>
                                  <th>
                                     <img class="img-fluid img-circle" src="{{asset('assets/auth/images/avatar-4.png')}}" alt="User">
                                  </th>
                               ...
                               <tr>
                                  <th>
                                     <img class="img-fluid img-circle" src="{{asset('assets/auth/images/avatar-1.png')}}" alt="User">
                                  </th>
                               ...
                               <tr>
                                  <th>
                                     <img class="img-fluid img-circle" src="{{asset('assets/auth/images/avatar-3.png')}}" alt="User">
                                  </th>
                                  <td>Contract with belife Company
                                     <p><i class="icofont icofont-clock-time"></i>Created 20.10.2016</p>
                                  </td>
              ...
              <ul class="iew-download">
                  <li>
                      <a href="http://www.google.com/chrome/">
                          <img src="assets/auth/images/browser/chrome.png" alt="Chrome">
                          <div>Chrome</div>
                      </a>
                  </li>
                  <li>
